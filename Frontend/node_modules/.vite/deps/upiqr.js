...
// node_modules/upiqr/dist/index.js
...
function upiqr({ payeeVPA: pa, payeeName: pn, payeeMerchantCode: me, transactionId: tid, transactionRef: tr, transactionNote: tn, amount: am, minimumAmount: mam, currency: cu }) {
  return new Promise((resolve, reject) => {
    ...
    if (tr)
      intent = buildUrl.call(intent, { tr });
    if (tn)
      intent = buildUrl.call(intent, { tn });
    intent = intent.substring(0, intent.length - 1);
    import_qrcode.default.toDataURL(intent).then((base64Data) => resolve({ qr: base64Data, intent })).catch((err) => reject(new Error("Unable to generate UPI QR Code.\n" + err)));
  });
}
export {
  upiqr as default
};
//# sourceMappingURL=upiqr.js.map
