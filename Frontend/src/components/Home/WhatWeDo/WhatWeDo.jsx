    ...
    return (
        <section className="v-wrapper back" id="about-us">
            <div className="paddings innerWidth flexCenter v-container">
                ...
                initial="hidden" 
                whileInView={"show"}
                viewport={{once: false, amount: 0.7}} className="v-left">
                ...
                <div className="flexColStart v-right">
                    ...
                    initial="hidden" 
                    whileInView={"show"}
                    viewport={{once: false, amount: 0.7}} className="glimpse">Glimpse of</motion.span>
                    <motion.span
                    variants={fadeIn("left", 0.3)} 
                    initial="hidden" 
                    whileInView={"show"}
                    viewport={{once: false, amount: 0.7}} 
                    className="primaryText weDo">What We Do</motion.span>
                    <motion.span
                    variants={fadeIn("left", 0.3)} 
                    initial="hidden" 
                    whileInView={"show"}
